...
export default function CharacterSelectModal({ target, onClose, onSelect }: CharacterSelectModalProps) {
  return (
          ...
          <div className="grid grid-cols-4 sm:grid-cols-6 md:grid-cols-8 gap-3">
            {charactersData.map((character) => (
              ...
              >
                ...
                <div className="text-xs text-center truncate w-full">{character.name}</div>
              </button>
            ))}
          </div>
        </div>
